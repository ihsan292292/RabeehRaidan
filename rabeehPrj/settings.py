"""
Django settings for rabeehPrj project.
...
SECRET_KEY = 'django-insecure-)cf4k)3b*nj$)=d+omx=d=jvr3lr@_ke0%ant1ew(ogp$gpb#7'
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': (
        ...
        # 'rest_framework.renderers.BrowsableAPIRenderer',  # Uncomment this if you want the browsable API
    ),
...
WSGI_APPLICATION = 'rabeehPrj.wsgi.application'
...
# Ensure both apps' static directories are included
STATICFILES_FINDERS = [
